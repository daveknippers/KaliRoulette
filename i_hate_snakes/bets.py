...
class bettingEngine():
    ...
    """
    def __init__(self, oddsEngine):
        self.BetsArray = []
        self.odds = oddsEngine
    def placeBet(self,twitchUser, bet, condition1, condition2=None, c, channelName):
        """
        ...
        if userMoney < bet:
            ...
            bet = userMoney
        # 3 and 4
        bettingOdds = self.odds.getOdds(condtion1, condtion2)
